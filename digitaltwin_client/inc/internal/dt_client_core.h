...
MOCKABLE_FUNCTION(, DIGITALTWIN_CLIENT_RESULT, DT_ClientCoreRegisterInterfacesAsync, DT_CLIENT_CORE_HANDLE, dtClientCoreHandle, const char*, deviceCapabilityModel, DIGITALTWIN_INTERFACE_CLIENT_HANDLE*, dtInterfaces , unsigned int, numDTInterfaces, unsigned int, dtDefaultInterfaceIndex, DIGITALTWIN_INTERFACE_REGISTERED_CALLBACK, dtInterfaceRegisteredCallback, void*, userContextCallback);
