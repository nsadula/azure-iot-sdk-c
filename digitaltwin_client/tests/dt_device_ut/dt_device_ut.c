...
static const unsigned int testDTDefaultInterfaceIndex = 0;
...
{
    STRICT_EXPECTED_CALL(DT_ClientCoreRegisterInterfacesAsync(IGNORED_PTR_ARG, testDTDeviceCapabilityModel, testDTInterfacesToRegister, testDTInterfacesToRegisterLen, testDTDefaultInterfaceIndex, dtTestDeviceRegisterInterfaceCallback, dtTestDeviceRegisterInterfaceCallbackContext));
}
...
TEST_FUNCTION(DigitalTwin_DeviceClient_RegisterInterfacesAsync_ok)
{
    ...
    result = DigitalTwin_DeviceClient_RegisterInterfacesAsync(h, testDTDeviceCapabilityModel, testDTInterfacesToRegister, testDTInterfacesToRegisterLen, testDTDefaultInterfaceIndex, dtTestDeviceRegisterInterfaceCallback, dtTestDeviceRegisterInterfaceCallbackContext);
