...
DIGITALTWIN_CLIENT_RESULT DigitalTwin_DeviceClient_LL_RegisterInterfacesAsync(
    DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE dtDeviceClientHandle,
...
{
    return DT_ClientCoreRegisterInterfacesAsync((DT_CLIENT_CORE_HANDLE)dtDeviceClientHandle, deviceCapabilityModel, dtInterfaces, numDTInterfaces, dtDefaultInterfaceIndex, dtInterfaceRegisteredCallback, userContextCallback);
}
